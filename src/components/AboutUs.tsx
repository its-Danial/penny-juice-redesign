    ...
    <div className="w-full mt-36 ">
      <div className="flex flex-row justify-between items-center">
        <div className="w-1/2 space-y-4">
          <h1 className="text-5xl text-orange-600 font-extrabold">About us</h1>
          <p className="text-gray-500 text-lg">
            We{"'"}re a family-owned business that was founded in 2001. We have over{" "}
            <span className="text-orange-600">40 years</span> of experience in the beverage industry.
          </p>
          <p className="text-gray-500 text-lg">
